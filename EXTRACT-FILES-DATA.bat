@echo off
echo ========================================
echo       EXTRACT FILES DATA
echo ========================================
echo This script will extract files data from Microsoft 365 and save it locally
echo.
...
powershell.exe -ExecutionPolicy Bypass -File "%~dp0extract-files-data.ps1" -UseRealData:$%use_real_data% -UseDevMode:$%use_dev_mode%
